...
class NNSAE:
    ...
    def __init__(self, inpDim, hidDim):
        ...
        self.W = scale * (2 * rand((self.inpDim, self.hidDim)) - 0.5 * ones((self.inpDim, self.hidDim))) + scale     #shared network weights, i.e. used to compute hidden layer activations and estimated outputs
        print self.W.shape
